                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 py-10 max-md:max-w-sm max-md:mx-auto">
                        ...
                        <div class="lg:mx-auto">
                            <h4 class="text-lg text-gray-400 font-medium mb-7 ">Sobre Nosotros</h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer text-gray-300 hover:text-gray-400">Inicio</a>
                                </li>
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Maps</a>
                                </li>
                                <li>
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Tel:3043068890</a>
                                </li>
                            </ul>
                        </div>
                        
                        <div class="lg:mx-auto">
                            <h4 class="text-lg text-gray-400 font-medium mb-7">Portafolio</h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer text-gray-300 hover:text-gray-400">van Gogh</a>
                                </li>
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Monet</a>
                                </li>
                                <li>
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Picasso</a>
                                </li>
                            </ul>
                        </div>
                        
                        <div class="lg:mx-auto">
                            <h4 class="text-lg text-gray-400 font-medium mb-7">Soporte</h4>
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer text-gray-300 hover:text-gray-400">Soporte</a>
                                </li>
                                <li class="mb-6">
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Términos y Condiciones</a>
                                </li>
                                <li>
                                    <a href="#" class="cursor-pointer  text-gray-300 hover:text-gray-400">Politica Privada</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="my-2 py-7">
                        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            <span class="text-sm text-gray-500 ">©PDT developer all rights reserved.</span>
